                ...
                <div class="modal-content">
                    ...
                    <form action="login" method="POST">
                        <div class="modal-body">
                            <i style="color: red; font-size: small;">El cambio de contraseña es imperativo la primera vez que ingresa o si el administrador ha reestablecido su contraseña</i> <br> <br>
