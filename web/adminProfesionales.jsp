...
<html lang="es">
    ...
    <body>
        <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item active"> <a class="nav-link" href="#">Profesionales <span
            ...
            <div class="row no-gutters pt-3" id="prodata">
                <div class="col-md-12">
                    <div class="card mb-3">
            ...
            <div class="row no-gutters pt-2" id="insercion">
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="card-header text-white bg-dark"> Profesionales </div>
                        <div class="card-body">
