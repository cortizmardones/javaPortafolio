...
<html lang="es">
    ...
    <head>
        ...
        <title>Seguros por siempre - Revisión de historial de operaciones</title>
    </head>
    ...
    <body>
        <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item"> <a class="nav-link active" href="baha?nav=aOperaciones">Operaciones <span
            ...
            <div class="row no-gutters pt-3" id="clienteData">
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="card-header text-white bg-dark"> Operaciones </div>
                        <div class="card-body" onmouseover="">
                            <table id="t2" class="table table-hover table-responsive-xl  table-dark ts">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td>Se agrego cliente Aramark</td>                                       
                                        <td>Mantención</td>                                      
                                        <td>Raúl Pardo Zurita</td>
                                        <td>20-08-2019 17:45</td>
                                    </tr>
                                </tbody>
                            </table> 
                        </div>
