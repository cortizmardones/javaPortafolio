    ...
    <body>
        <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="baha?nav=aProfesionales">Solicitudes</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="baha?nav=aClientes">Pagos</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="baha?nav=aPagos">Informes</a> </li>
            ...
            <div class="row no-gutters pt-2" id="insercion">
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="card-header text-white bg-success">Envío de mensajes</div>
                        <div class="card-body">
                            <form>
